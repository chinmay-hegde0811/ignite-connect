import { Util } from '@ignite/ctintegration-do';

export class Common {
  public static hasAuthHeaderOrThrowError(request: Util.Types.Ignite.Request) {
  ...
  public static hasRequiredParamsInBody(body: {
  ...
  public static hasRequiredParamsInQueryString(queryString: {
  ...
  public static async retry(
    action: Util.Types.Ignite.Action,
    maxAttemptCount = 3,
  ) {
