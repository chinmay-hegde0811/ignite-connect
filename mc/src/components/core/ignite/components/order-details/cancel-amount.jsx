                    ...
                    <div className="transaction-form-wrapper">
                        <div className='transaction-form'>
                            <div className="input-block">
                                <p className="input-label">{formatMessage(messages.amountToCancel)}</p>
                                <input
                                    type="number"
                                    name="cancelAmount"
                                    value={cancelAmount}
                            ...
                            <div className="transaction-button" onClick={cancelPayment}>
                                {loading ? <LoadingSpinner /> : <PrimaryButton label={formatMessage(messages.cancel)} />}
                            </div>
                        </div>
                        <div className="transaction-details">
                            {formatMessage(messages.amountCancelledAlready)} <b>{currencyCode} {alreadyCancelledAmount}</b>
